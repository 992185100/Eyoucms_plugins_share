...
namespace weapp\Contactmz\controller;

use think\Db;
use app\common\controller\Weapp;
use weapp\Contactmz\model\ContactmzModel;

/**
 * 插件的控制器
 */
class Contactmz extends Weapp
{
    ...
    private $scan_url = '/weapp/Contactmz/template/skin/images/weixin.png';
    ...
    public function index()
    {
        ...
        if (isset($contact['data']['wechat_logo']) && is_http_url($contact['data']['wechat_logo'])) {
            ...
            $contact['data']['wechat_logo_local'] = !empty($contact['data']['wechat_logo']) ? $contact['data']['wechat_logo'] : '/weapp/Contactmz/template/skin/images/weixin.png';
        }
        /*--end*/
        ...
        if (IS_POST) {
            ...
            if (!empty($data['code'])) {
                ...
                if ($r) {
                    ...
                    $this->success("操作成功!", weapp_url('Contactmz/Contactmz/index'));
                }
            }
        }
        $this->error("操作失败");
